...
def test_update_datetime_calls_publish_with_correct_data():
    ...
    #Assert
    dashboard_updater._mqtt_manager.publish.assert_called_with("ds/deviceTime",f"04:00 - Monday",retain=True)
...
def test_reset_dashboard_buttons_calls_publish():
    ...
    #Assert
    dashboard_updater._mqtt_manager.publish.assert_has_calls([call("ds/startSection",0),call("ds/runPump",0)])